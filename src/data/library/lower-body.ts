...
export const LOWER_BODY_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    level: "Beginner",
    mechanics: "Isolation",
    summary: "Heavy calf raises with the load on your shoulders — the main calf builder in most gyms.",
    steps: [
      "Set the shoulder pads (or a Smith bar) so you have to bend your knees slightly to get under them.",
      "Stand with the balls of your feet on the edge of the step, heels hanging off.",
      "Lower your heels until you feel a deep stretch in your calves.",
      "Drive up onto your toes as high as you can, pause, then lower slowly.",
    ],
    tips: ["Pause 1–2 s at the bottom stretch — it stops the Achilles bounce.", "Knees stay straight but not locked."],
    mistakes: ["Bouncing out of the bottom", "Half reps", "Bending the knees to push the weight"],
